OBJS = ast.cmx sast.cmx parser.cmx scanner.cmx utils.cmx semant.cmx codegen2.cmx javapm.cmx
...
parser.cmi : ast.cmo 
javapm.cmo : scanner.cmo parser.cmo codegen2.cmo ast.cmo sast.cmo semant.cmo utils.cmo
javapm.cmx : scanner.cmx parser.cmx codegen2.cmx ast.cmx sast.cmx semant.cmx utils.cmo
parser.cmi : ast.cmo
